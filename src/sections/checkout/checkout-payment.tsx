...
import { useGetCart, useCheckout } from 'src/api/production-requirements';
...
export default function CheckoutPayment() {
  ...
  const { cart, totalAmount, reFetchCart } = useGetCart(eventData?.state.eventId);
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      await checkoutCart(eventData?.state.eventId);
      checkout.onNextStep();
      checkout.onReset();
