...
export default function PaymentDialog({
  ...
  console.log("Payment Details:123 ", paymentDetails);
  ...
  const calculateAmountToPay = (percentage: number) => {
    ...
    const remainingAmount = totalAmountToPay - paidAmount;

    const amountToPay = (percentage / 100) * remainingAmount;
    return amountToPay;
  };
  ...
  //   setIsLoading(true);
  //   try {
  //     const res = await axios.get(API_URL + "/payment/user/" + urn);
  //     console.log(res.data.data);
  //     setPaymentDetails(res.data.data as PaymentDetails);
  //     setIsLoading(false);
  //   } catch (error) {
  //     console.log(error);
  //     setIsLoading(false);
          ...
          <div className="flex flex-col items-start h-full w-full mt-2">
            ...
            <ul className="grid md:grid-cols-2 grid-cols-1 gap-4 w-full">
              ...
              <li>
                ...
                <br />
                <span className="text-gray-600">
                  Due By: 15th March 2026
                </span>
              </li>
              <li>
                <strong className="text-lg">Final Payment – 50%</strong>
                <br />
                <span className="text-gray-600">
                  Due By: 15th May 2026
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="flex gap-6 w-full lg:w-1/2">
              {[25, 50, 100].map((percentage) => (
                ...
                >
                  <input
                    type="radio"
                    className="form-radio h-5 w-5 text-[#ffa206] border-gray-300"
                    value={percentage}
                    checked={
                      getValues("percentageLikeToPay") === percentage
                    }
                    onChange={(e) => {
                      setValue(
                        "percentageLikeToPay",
