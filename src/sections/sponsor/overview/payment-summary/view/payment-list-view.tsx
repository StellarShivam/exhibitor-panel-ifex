...
import { useGetPaymentDetails, usePaymentBySponsorID, useTransactionsBySponsorID } from 'src/api/sponsor-payments';
...
export default function SponsorPaymentSummaryListView() {
  ...
  const { payment, paymentLoading, refetchPayment } = usePaymentBySponsorID();
  ...
  useEffect(() => {
    setTableData(payment?.metaData?.data ?? []);
  }, [payment]);
          ...
          <Box>
            ...
            <Box>
              ...
              {paymentDetails?.tdsAmount > 0 && (
                <Box fontWeight={'bold'} fontSize={12} color="text.primary">
                TDS : {fCurrencyWithType(paymentDetails?.tdsAmount, paymentDetails?.currency || "INR").formatted}{' '}
              </Box>
              )}
              <Box fontWeight={'bold'} fontSize={12} color="text.primary">
      ...
      <Card sx={{ mt: 1 }}>
        ...
        <Box p={2}>
          ...
          <Box component="ol" sx={{ pl: 3, mt: 1, mb: 0 }}>
            <li>
              <strong>First Payment – 25%</strong>
              <br />
              <span>Due By: 15th January 2026</span>
            </li>
            <li>
              <strong>Second Payment – 25%</strong>
              <br />
              <span>Due By: 15th March 2026</span>
            </li>
            <li>
              <strong>Final Payment – 50%</strong>
              <br />
              <span>Due By: 15th May 2026</span>
            </li>
          </Box>
        </Box>
      </Card>
